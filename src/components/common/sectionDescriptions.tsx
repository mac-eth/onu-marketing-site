...
const SectionDescriptions: React.FC<Props> = ({ heading, description }) => {
  return (
    <div className="bg-primary py-12 rounded-3xl border-2 border-black shadow-md shadow-black mx-auto max-w-md text-center sm:max-w-3xl lg:max-w-7xl lg:px-8">
