...
const TitleButtons: React.FC = () => {
  return (
    <div className="flex justify-center lg:justify-start mt-12 gap-6 pb-8">
      <button className="px-6 py-3 rounded-xl shadow-md bg-gray-100 shadow-secondary border-2 border-secondary text-black font-poppins font-medium text-lg lg:text-xl hover:bg-secondary hover:text-white">
        Read More
      </button>
