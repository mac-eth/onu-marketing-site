      ...
      <div className="hidden lg:flex lg:items-center lg:justify-between mx-24 py-6 text-lg font-poppins">
        ...
        <div>
          ...
          <div className="inline-block px-7 py-2">
            <button className=" px-4 py-2 text-black font-semibold bg-white  rounded-xl shadow-md shadow-secondary outline-none border-2 border-secondary hover:bg-secondary hover:text-white hover:border-black ">
